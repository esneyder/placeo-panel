...
const NationalitiesTable = React.lazy(() =>
  import("./App/Nationalities/NationalitiesTable")
);
const CitiesTable = React.lazy(() => import("./App/Cities/CitiesTable"));
